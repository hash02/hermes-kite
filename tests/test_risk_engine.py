...
def _policy(engine_enabled=True, kelly=0.25, target_vol=8.0,
            max_cp_pct=30.0, dd_halt=None, fund_capital=1000.0,
            n_sleeves_in_fund=4):
...
class TestApplyEngine(unittest.TestCase):
    ...
    def test_drawdown_halt_zeros_size(self):
        ...
        policy = _policy(engine_enabled=True, kelly=0.25, target_vol=8.0,
                         dd_halt=5.0, fund_capital=1000.0)
...
class TestRealizedVol(unittest.TestCase):
    def test_bootstrap_when_insufficient_history(self):
        ...
        positions = [
            {"worker": "aave_usdc", "sleeve": "fund_test.sleeve_0",
             "resolved": True, "principal_usd": 100, "pnl_usd": 2.0},
    ...
    def test_computed_vol_with_enough_history(self):
        ...
        positions = [
            {"worker": "tv_momentum", "sleeve": "fund_test.sleeve_0",
             "resolved": True, "principal_usd": 100, "pnl_usd": 1.0}
            for _ in range(6)
        ]
    ...
    def test_computed_vol_reflects_spread(self):
        ...
        positions = [
            {"worker": "tv_momentum", "sleeve": "fund_test.sleeve_0",
             "resolved": True, "principal_usd": 100,
