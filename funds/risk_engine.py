...
def _print_table(worker_names: list[str], engine_on: bool):
    ...
    print(f"  max_concentration_per_counterparty_pct = {risk.get('max_concentration_per_counterparty_pct')}")
    print(f"  max_drawdown_halt_per_fund_pct         = {risk.get('max_drawdown_halt_per_fund_pct')}")
    print()
